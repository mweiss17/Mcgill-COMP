...
public final class Milestone1Driver
{
	...
	public static void main(String[] pArgs) throws Exception
	{
		...
		String key = loader.loadMP(MULCAIR, Parliament.getInstance());
		loader.loadRecentEvents(key, Parliament.getInstance());
		MP mulcair = Parliament.getInstance().getMP(key); // Requires additional implementation.
